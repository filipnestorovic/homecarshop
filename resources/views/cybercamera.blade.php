...
<html>
<head>
    <meta name="facebook-domain-verification" content="801lmsi3obmtbrkqdr9k742oclcmo4" />
...
{{--                        <img src="{{ asset('/') }}dailysharkFiles/cybercamera/header-img.png" alt=""/>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="header__left">--}}
{{--                    <div class="header__text">--}}
{{--                        <div class="header__descr">--}}
{{--                            <h1 class="header__title">CYBER CAMERA</h1>--}}
...
{{--                        <img src="{{ asset('/') }}dailysharkFiles/cybercamera/1.jpg" alt="">--}}
{{--                    </div>--}}
...
{{--                        <p>Cyber kamera vam omogućava da u realnom vremenu pratite šta se dešava u vašem domu, kancelariji, skladištu, prodanvnici ili bilo gde drugde.--}}
{{--                            Možete daljinski pratiti događaje koristeći svoj mobilni telefon, gde god se nalazili na zemljinoj kugli.</p>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                    </div>--}}
{{--                    <div class="promo__img">--}}
{{--                        <img src="{{ asset('/') }}dailysharkFiles/cybercamera/2.jpg" alt="">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="promo__row">--}}
{{--                    <div class="promo__img">--}}
{{--                        <img src="{{ asset('/') }}dailysharkFiles/cybercamera/3.jpg" alt="">--}}
{{--                    </div>--}}
{{--                    <div class="promo__text">--}}
...
{{--                            <source src="{{ asset('/') }}dailysharkFiles/cybercamera/001.mp4" type="video/mp4">--}}
{{--                        </video>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="works__col">--}}
{{--                    <div class="works__img">--}}
{{--                        <img src="{{ asset('/') }}dailysharkFiles/cybercamera/4.jpg" alt="">--}}
{{--                    </div>--}}
...
{{--                        </div>--}}
{{--                        <div class="slider__item">--}}
{{--                            <img src="{{ asset('/') }}dailysharkFiles/cybercamera/6.jpg" alt="">--}}
{{--                        </div>--}}
{{--                        <div class="slider__item">--}}
{{--                            <img src="{{ asset('/') }}dailysharkFiles/cybercamera/7.jpg" alt="">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                                <img src="{{ asset('/') }}dailysharkFiles/cybercamera/rev1.jpg" alt=""/>--}}
{{--                            </div>--}}
...
{{--                        <div class="block__header">--}}
{{--                            <div class="block__img">--}}
{{--                                <img src="{{ asset('/') }}dailysharkFiles/cybercamera/rev3.jpg" alt=""/>--}}
{{--                            </div>--}}
{{--                            <div class="block__text">--}}
...
{{--                        </div>--}}
{{--                        <p class="feedback">--}}
{{--                            Super je što uvek mogu da pratim šta se dešava oko moje kuće. Kamera je baš zgodna za sve namere. Moje preporuke!--}}
{{--                        </p>--}}
{{--                    </div>--}}
{{--                    <div class="block__footer">--}}
{{--                        <img src="{{ asset('/') }}dailysharkFiles/pixipcamera/stars.png" alt="">--}}
...
{{--                        <div class="block__header">--}}
{{--                            <div class="block__img">--}}
{{--                                <img src="{{ asset('/') }}dailysharkFiles/cybercamera/rev4.jpg" alt=""/>--}}
{{--                            </div>--}}
{{--                            <div class="block__text">--}}
{{--                                <p class="bold">Tomo</p>--}}
{{--                                <img src="{{ asset('/') }}dailysharkFiles/pixipcamera/stars.png" alt="">--}}
